    ...
    <>
      ...
      <div className={sty.introTextContainer}>
        <p className={sty.dashIntroPara}>
          The Postal Regulatory Commission has launched an interactive dashboard
          that provides visual data and interactive tools to allow the public to
          view the service performance results for many Market Dominant mail
          products (and product components) delivered by the United States
          Postal Service (USPS).
        </p>
        <p className={sty.dashIntroPara}>
        ...
        <p className={sty.dashIntroPara}>
          ...
          comments on it, Congress passed the Postal Service Reform Act of 2022,
          and the President signed the reform bill into law on April 6, 2022.{" "}
          <i>See&nbsp;</i>
          <a
            rel="noreferrer"
            target="_blank"
          ...
          >
            <u>
              Postal Service Reform Act, Pub. L. 117-108, 136 Stat. 1127 (April
              6, 2022
            </u>
            )
          </a>
        ...
        <ul>
          ...
          <li>
            recommending any changes to the Postal Service's measurement systems
            that the Commission deems necessary for measurement and publication
            of service performance information on the dashboard; and
          </li>
          <li>
            regularly consulting with the Postal Service on appropriate features
            and information for the Postal Service's dashboard.
          </li>
        </ul>
        The Commission published the dashboard requirements and recommended
        changes to the Postal Service's measurement systems on February 9, 2023
        in Order No. 6439.
      </div>
      <div className={sty.introTextContainer}>
        <Grid>
      ...
      <div className={sty.glossaryContainer}>{/* <HomePageGlossary /> */}</div>
